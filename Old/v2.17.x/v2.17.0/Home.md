...
### ⚠️ Keep up to date ⚠️
Make sure to check the [Planned Changes](https://github.com/users/Tomshiii/projects/1) project page to see if any small bugs/features are currently being tracked/worked on.
</div>
...
- This repo makes use of some `ImageSearch` (especially for `Premiere`) and as such things *might* not work right out of the box. If you run into any issues with scripts just not finding their respective images, you may need to take your own screenshots and replace those within `..\Support Files\ImageSearch\`
